...
export function nav() {
	...
	<figure class="standardCard">
		<img src="/media/img/pheonix.png"
			alt="The original Mozilla Phoenix logo before eventually being rebranded into a fox">
		<figcaption>
			The original <a href="https://en.wikipedia.org/wiki/Firefox#History" target="_blank"
				rel="noopener noreferrer">Mozilla Firefox</a> logo from 2002, when it was still named
			<i>Phoenix</i>, and then later <i>Firebird</i>, before rebranding to <i>Firefox</i>
		</figcaption>
	</figure>
	<p>
		Pipertext is a love letter to the old web; when it seemed to be a never-ending adventure through others'
		little corners of the grand series of tubes you're viewing this website through. I was personally born
		too late to have seen it myself, but regardless I have become very fond of the aesthetics and culture of
		the time.
	</p>
	<p>
		The early web was a human experience. Compared to today, anyways; websites weren't so cookie cutter and
		lifeless, and websites made by ordinary people were the majority, showing off their interests, passions,
		and ability to write killer sites. I've grown up in a world where the web is primarily accessed through
		social media; divisive content designed to keep you addicted is the norm. This site is my contribution
		to the human-centric web!
	</p>
	<p>
		I've compiled
		<a href="#resource">some resources</a> if you're
		interested in making your website look like it's straight out of the
		Y2K era. But make sure to start with <a href="https://www.theodinproject.com/" target="_blank"
			rel="noopener noreferrer">the basics</a>! Keep on puffing! :D
	</p>
	<div id="smokeLounge">
		<h3>the smoke lounge</h3>
		<div id="smokeLoungeContent">
			<div id="smokeLoungeChat">
				<em>currently under construction... check back later! ;)</em>
			</div>
			<div id="smokeLoungePoll">
				mwaha
			</div>
		</div>
	</div>
