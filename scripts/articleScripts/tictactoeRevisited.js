...
class Board {
	...
	checkResult() {
		// verticals
		for (let y = 0; y < 3; y++) {
			if (this._board[y][0] === this._board[y][1] && this._board[y][1] === this._board[y][2]) {
		...
		// horizontals
		for (let x = 0; x < 3; x++) {
			if (this._board[0][x] === this._board[1][x] && this._board[1][x] === this._board[2][x]) {
		...
		// diagonals
		if ((this._board[0][0] === this._board[1][1] && this._board[1][1] === this.board[2][2])
			|| (this._board[0][2] === this._board[1][1] && this._board[1][1] === this.board[2][0])) {
